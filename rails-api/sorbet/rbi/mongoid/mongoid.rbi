...
module Mongoid
  ...
  VERSION = T.let("7.2.0", String)
  PLATFORM_DETAILS = T.let("mongoid-#{VERSION}".freeze, String)
  MONGODB_VERSION = T.let("2.6.0", String)
  ...
  module GlobalDiscriminatorKeyAssignment
    class InvalidFieldHost
      ...
      LIST_OPERATIONS = T.let([ "$addToSet", "$push", "$pull", "$pullAll" ].freeze, T::Array[String])
      StringifiedSymbol = T.let(Mongoid::StringifiedSymbol, Class)
      TYPE_MAPPINGS = T.let({
        array: Array,
        ...
        symbol: Symbol,
        time: Time
      }.with_indifferent_access, T::Hash[Symbol, Class])
      IDS = T.let([ :_id, :id, '_id', 'id' ].freeze, [Symbol, Symbol, String, String])
      CREATE_LOCK = T.let(Mutex.new, Thread::Mutex)
      UPDATES = T.let([
        :atomic_array_pushes,
        :atomic_array_pulls,
      ...
      sig { returns(Integer) }
      def hash; end
      sig { returns [Class, BSON::ObjectId] }
      def identity; end
      ...
      # This will return all attributes with the exception of the document's id,
      # and will reset all the instance variables.
      #
  ...
  version: VERSION,
    ...
    module Options
      ...
      module ClassMethods
        ...
        sig { params(options: T::Hash[Symbol, T.any(String, Symbol)], block: T.proc.params(m: Document).void).returns(T.untyped) }
        def with(options, &block); end
        sig { returns(Mongoid::PersistenceContext) }
        def persistence_context; end
      end
    end
    module Sessions
  ...
  :extend
      ...
      PRIMARY_KEY_DEFAULT = T.let('_id'.freeze, String)
      sig do
        params(
          _class: Class,
          name: Symbol,
