...
class Mongo::BulkWrite
  ...
  def execute_operation(name, values, connection, operation_id, result_combiner, session, txn_num = T.unsafe(nil)); end
...
class Mongo::Client
  ...
  def validate_new_options!(opts = T.unsafe(nil)); end
...
class Mongo::Cluster
  ...
  class << self
    ...
    def finalize(pools, periodic_executor, session_pool); end
  end
end
...
class Mongo::Cluster::PeriodicExecutor
  ...
  def initialize(executors = T.unsafe(nil), options = T.unsafe(nil)); end
...
class Mongo::Collection::View
  ...
  def apply_collation!(doc, server, opts = T.unsafe(nil)); end
...
Mongo::Collection::View::Builder::FindCommand::MAPPINGS = T.let(T.unsafe(nil), BSON::Document)
...
Mongo::Collection::View::Builder::Flags::MAPPINGS = T.let(T.unsafe(nil), Hash)
...
Mongo::Collection::View::Builder::MapReduce::OUT_ACTIONS = T.let(T.unsafe(nil), Array)
...
Mongo::Collection::View::Builder::Modifiers::DRIVER_MAPPINGS = T.let(T.unsafe(nil), BSON::Document)

Mongo::Collection::View::Builder::Modifiers::SERVER_MAPPINGS = T.let(T.unsafe(nil), BSON::Document)
...
Mongo::Collection::View::Readable::MODIFIERS = T.let(T.unsafe(nil), String)

Mongo::Collection::View::Readable::QUERY = T.let(T.unsafe(nil), String)
...
module Mongo::Collection::View::Writable
  ...
  def apply_array_filters!(doc, server, opts = T.unsafe(nil)); end
...
class Mongo::Cursor
  ...
  class << self
    def finalize(cursor_id, cluster, op_spec, server, session); end
  end
end
...
class Mongo::Cursor::Builder::GetMoreCommand
  ...
  def initialize(cursor, session = T.unsafe(nil)); end
...
class Mongo::Cursor::Builder::KillCursorsCommand
  ...
  class << self
    def get_cursors_list(spec); end
    def update_cursors(spec, ids); end
  end
end
...
class Mongo::Monitoring::Event::CommandFailed < ::Mongo::Event::Base
  ...
  class << self
    def generate(address, operation_id, payload, message, failure, duration); end
  end
end
...
class Mongo::Monitoring::Event::CommandStarted < ::Mongo::Event::Base
  ...
  def initialize(command_name, database_name, address, request_id, operation_id, command, socket_object_id: T.unsafe(nil), connection_id: T.unsafe(nil), connection_generation: T.unsafe(nil), server_connection_id: T.unsafe(nil)); end
  ...
  class << self
    def generate(address, operation_id, payload, socket_object_id: T.unsafe(nil), connection_id: T.unsafe(nil), connection_generation: T.unsafe(nil), server_connection_id: T.unsafe(nil)); end
  end
end
...
class Mongo::Monitoring::Event::CommandSucceeded < ::Mongo::Event::Base
  ...
  class << self
    def generate(address, operation_id, command_payload, reply_payload, duration); end
...
class Mongo::Monitoring::Event::ServerHeartbeatFailed < ::Mongo::Event::Base
  def initialize(address, round_trip_time, error, awaited: T.unsafe(nil)); end
...
class Mongo::Monitoring::Event::ServerHeartbeatSucceeded < ::Mongo::Event::Base
  def initialize(address, round_trip_time, awaited: T.unsafe(nil)); end
...
module Mongo::Monitoring::Publishable
  ...
  def command_started(address, operation_id, payload, socket_object_id: T.unsafe(nil), connection_id: T.unsafe(nil), connection_generation: T.unsafe(nil), server_connection_id: T.unsafe(nil)); end
...
class Mongo::Operation::CollectionsInfo::Command
  ...
  def get_result(connection, client, options = T.unsafe(nil)); end
  def message(connection); end
...
module Mongo::Operation::Executable
  ...
  def do_execute(connection, client, options = T.unsafe(nil)); end
  def execute(connection, client:, options: T.unsafe(nil)); end

  private

  def build_message(connection); end
  def dispatch_message(connection, client, options = T.unsafe(nil)); end
  def get_result(connection, client, options = T.unsafe(nil)); end
...
module Mongo::Operation::OpMsgOrCommand
  ...
  def execute(server, client:, options: T.unsafe(nil)); end
...
Mongo::Operation::Specifiable::CURSOR_IDS = T.let(T.unsafe(nil), Symbol)
...
Mongo::Protocol::Query::Upconverter::FILTER = T.let(T.unsafe(nil), String)

Mongo::Protocol::Query::Upconverter::FIND = T.let(T.unsafe(nil), String)
...
class Mongo::Server::ConnectionBase < ::Mongo::Server::ConnectionCommon
  ...
  def cluster_time(*args, &block); end
  def description; end
  def dispatch(messages, operation_id = T.unsafe(nil), client = T.unsafe(nil), options = T.unsafe(nil)); end
  def features(*args, &block); end
  def generation; end
  def max_bson_object_size(*args, &block); end
  def max_message_size(*args, &block); end
  ...
  def deliver(message, client, options = T.unsafe(nil)); end
  def serialize(message, client, buffer = T.unsafe(nil)); end
end
...
class Mongo::Server::Description
  def initialize(address, config = T.unsafe(nil), average_round_trip_time = T.unsafe(nil)); end
...
Mongo::Server::Monitor::Connection::ISMASTER = T.let(T.unsafe(nil), Hash)

Mongo::Server::Monitor::Connection::ISMASTER_BYTES = T.let(T.unsafe(nil), String)

Mongo::Server::Monitor::Connection::ISMASTER_MESSAGE = T.let(T.unsafe(nil), Mongo::Protocol::Query)

Mongo::Server::Monitor::Connection::ISMASTER_OP_MSG = T.let(T.unsafe(nil), Hash)

Mongo::Server::Monitor::Connection::ISMASTER_OP_MSG_BYTES = T.let(T.unsafe(nil), String)

Mongo::Server::Monitor::Connection::ISMASTER_OP_MSG_MESSAGE = T.let(T.unsafe(nil), Mongo::Protocol::Msg)
...
class Mongo::ServerSelector::Base
  ...
  def options; end
  def select_server(cluster, ping = T.unsafe(nil), session = T.unsafe(nil)); end
...
Mongo::URI::SRVProtocol::INVALID_TXT_RECORD_OPTION = T.let(T.unsafe(nil), String)
